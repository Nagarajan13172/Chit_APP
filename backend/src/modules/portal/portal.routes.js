...
import { loginSchema, paySchema, updateProfileSchema } from "./portal.validation.js";
...
router.patch("/me", authenticateCustomer, validate(updateProfileSchema), portalController.updateProfile);
